...
$rel_caixas = 'ocultar';
$rel_trocas = 'ocultar';
$rel_vendas_produtos = 'ocultar';

//Centros de Custo

$administracao = 'ocultar';
$centro_de_simulacao = 'ocultar';
...
if($total_reg > 0){
	for($i=0; $i < $total_reg; $i++){
		...
		if($chave == 'rel_vendas_produtos'){
			$rel_vendas_produtos = '';
		}

		if($chave == 'administracao'){
			$administracao = '';
		}

		if($chave == 'centro_de_simulacao'){
			$centro_de_simulacao = '';
		}
...
if($rel_produtos == 'ocultar' and $rel_entradas_saidas == 'ocultar' and $rel_comissoes == 'ocultar' and $rel_recebimentos == 'ocultar' and $rel_clientes == 'ocultar' and $rel_lucro == 'ocultar' and $rel_vendas == 'ocultar' and $rel_despesas == 'ocultar' and $rel_estoque == 'ocultar' and $rel_caixas == 'ocultar' and $rel_trocas == 'ocultar'  and $rel_vendas_produtos == 'ocultar'){
...
if($centro_de_simulacao == 'ocultar' and $administracao == 'ocultar'){
	$menu_centros_de_custo = 'ocultar';
}else{
	$menu_centros_de_custo = '';
}
