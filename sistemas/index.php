...
<body class="cbp-spmenu-push">
			...
			<aside class="sidebar-left" style="overflow: scroll; height:100%; scrollbar-width: thin;">
				...
				<nav class="navbar navbar-inverse">
					<div class="navbar-header">
						...
						<h1><a class="navbar-brand" href="index.php"></span><span class=""><span id="nome_sistema_titulo"></span></span></a></h1>
					</div>
						...
						<ul class="sidebar-menu">
							...
							<li class="treeview <?php echo $menu_cadastros ?>">
								...
								<ul class="treeview-menu">
									...
									<li class="<?php echo $funcionarios ?>"><a href="index.php?pagina=funcionarios"><i class="fa fa-angle-right"></i> Colaboradores</a></li>
							...
							<li class="treeview <?php echo $menu_financeiro ?>">
								...
								<ul class="treeview-menu">
									<li class="<?php echo $receber ?>"><a href="index.php?pagina=receber"><i class="fa fa-angle-right"></i> Contas a Receber</a></li>

									<li class="<?php echo $pagar ?>"><a href="index.php?pagina=pagar"><i class="fa fa-angle-right"></i> Contas a Pagar</a></li>

									<li class="<?php echo $despesas_viagens ?>"><a href="index.php?pagina=despesas_viagens"><i class="fa fa-angle-right"></i> Despesas com Viagens</a></li>

									<li class="<?php echo $orcamento ?>"><a href="index.php?pagina=orcamento"><i class="fa fa-angle-right"></i> Orçamento</a></li>
							...
							<li class="treeview <?php echo $menu_relatorio ?>">
								...
								<ul class="treeview-menu">
									...
									<li class="<?php echo $rel_vendas_produtos ?>"><a href="#" data-toggle="modal" data-target="#relVendasProdutos"><i class="fa fa-angle-right"></i> Relatório Vendas Produtos</a></li>
									
								</ul>
							</li>

							<li class="treeview <?php echo $menu_centros_de_custo ?>">
								<a href="#">
									<i class="fa fa-usd"></i>
									...
									<li class="<?php echo $administracao ?>"><a href="index.php?pagina=administrativo"><i class="fa fa-angle-right"></i> Administração Central</a></li>

									<li class="<?php echo $centro_de_simulacao ?>"><a href="index.php?pagina=centro_de_simulacao"><i class="fa fa-angle-right"></i> Centro de Simulação</a></li>

								</ul>
							</li>

							<!--<li class="treeview <?php echo $gerador_de_certificados ?>">
								<a href="#">
									...
									<li class="<?php echo $gerar_certificado ?>"><a href="index.php?pagina=administrativo"><i class="fa fa-angle-right"></i> Gerador de Certificados</a></li>

									<li class="<?php echo $criar_certificado ?>"><a href="index.php?pagina=centro_de_simulacao"><i class="fa fa-angle-right"></i> Criador de Certificados</a></li>
	...
	-->
							...
							$query = $pdo->query("SELECT * FROM empresas where email = '$email_usuario' and ativo = 'Sim'");
							$res = $query->fetchAll(PDO::FETCH_ASSOC);
							$total_reg = @count($res);
							if($total_reg > 1){
		...
		<!--Icone de Aniversários-->
						<li class="dropdown head-dpdn">
							<?php 
							$query = $pdo->query("SELECT * FROM usuarios where MONTH(data_nascimento) = MONTH(curDate()) AND DAY(data_nascimento) = DAY(curDate())  and empresa = '$id_empresa' order by nome asc");
							$res = $query->fetchAll(PDO::FETCH_ASSOC);
							$total_reg = @count($res);
							if($total_reg <= 1){
								 $texto_pendentes = 'Aniversariante(s)';
								}else{
									$texto_pendentes = 'Aniversariante(s)';
								}
							...
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-birthday-cake" style="color:#FFF; width:15px; height:15px"></i><span class="badge" style="background:red"><?php echo $total_reg ?></span></a>
							<ul class="dropdown-menu">
								<li>
									<div class="notification_header">
										<h3>Possui <?php echo $total_reg ?> <?php echo $texto_pendentes ?> </h3>
								...
								<li>
									<div class="notification_bottom">
										<a href="index.php?pagina=funcionarios">Ver todos os Colaboradores</a>
									</div> 
								</li>
							</ul>
						</li>
			...
			<div class="modal-body">
					...
					<div class="row">
						<div class="col-md-12">							
								...
								<input type="text" class="form-control" id="chave_pix_perfil" name="pix" placeholder="Chave Pix" >							
						</div>
			...
			<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-md-3">							
							...
							<div class="col-md-4">							
								<label>Instância Api</label>
								<input type="text" class="form-control" id="instancia" name="instancia" placeholder="Instância Whatsapp"  >							
						</div>
					...
					<div class="row">	
						...
						<div class="col-md-7">							
								<label>Token Api Pix</label>
								<input type="text" class="form-control" id="token_pix" name="token_pix" placeholder="Token Api Pix"  >							
						</div>

						<div class="col-md-5">							
								<label>Chave Pix (Não for usar APi)</label>
								<input type="text" class="form-control" id="chave_pix_sistema" name="chave_pix_sistema" placeholder="Chave Pix Opcional"  >							
						</div>
...
<!-- Modal Rel Comissões -->
<div class="modal fade" id="relVendasProdutos" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" id="exampleModalLabel">Relatório de Vendas de Produtos
				</h4>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close" style="margin-top: -20px">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<form method="post" action="../rel_sistema/vendas_produtos_class.php" target="_blank">
				<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-md-4">
							<div class="form-group"> 
								...
								<select class="form-control" name="busca" style="width:100%;">
									<option value="mais">Mais Vendidos</option>							
	...
	function carregarDadosConfig(){
		...
		$.ajax({
			...
			success: function (result) {
				...
				$('#token').val(split[9]);
				$('#instancia').val(split[10]);
				$('#token_pix').val(split[11]);
				$('#chave_pix_sistema').val(split[12]);
