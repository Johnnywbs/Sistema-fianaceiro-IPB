...
$token_pix = $_POST['token_pix'];
$chave_pix_sistema = $_POST['chave_pix_sistema'];
...
$query = $pdo->prepare("UPDATE config SET nome_sistema = :nome_sistema, email_sistema = :email_sistema, telefone_sistema = :telefone_sistema, tipo_rel = '$tipo_rel', foto_rel = '$foto', tipo_desconto = '$tipo_desconto', comissao = '$comissao', endereco_sistema = '$endereco_sistema', cnpj_sistema = '$cnpj_sistema', token = '$token', instancia = '$instancia', token_pix = '$token_pix', chave_pix_sistema = '$chave_pix_sistema' where empresa = '$id_empresa'");
