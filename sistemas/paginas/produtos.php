...
if(@$produtos == 'ocultar'){
 ...
 <a class="btn btn-primary" onclick="inserir()" class="btn btn-primary btn-flat btn-pri"><i class="fa fa-plus" aria-hidden="true"></i> Novo Item</a>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">	
					...
					<div class="col-md-6" style="margin-bottom: 5px">
						<span><b>Vendas: </b></span><span id="vendas_produtos_dados"></span>
					</div>
...
function excluirItensGrade(id){	
    ...
    $.ajax({
        ...
        success:function(mensagem){
            if (mensagem.trim() == "Excluído Sucesso") {
                listarItensGrade(id_prod);
            } 
        }
    });
