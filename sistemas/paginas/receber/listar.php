...
<a href="#" onclick="parcelar('{$id}', '{$valorF}')" title="Parcelar Conta" style="text-decoration: none">
<i class="fa fa-calendar text-success mx-1"></i>
</a>
...
<script type="text/javascript">
	...
	function parcelar(id, valor){

			$('#id_usuario_parcelar').val(localStorage.id_usu);	
		$('#id_empresa_parcelar').val(localStorage.id_empresa);

			$('#id_parcelar').val(id);
			$('#valor_conta').text(valor);
