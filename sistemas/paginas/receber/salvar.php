...
if($id == ""){
	$query = $pdo->prepare("INSERT INTO $tabela SET empresa = '$id_empresa', tipo = 'Conta', descricao = :descricao, pessoa = '$pessoa', valor = :valor, data_venc = '$data_venc', frequencia = '$frequencia', data_lanc = curDate(), usuario_lanc = '$id_usuario', arquivo = '$foto', pago = 'Não'");
