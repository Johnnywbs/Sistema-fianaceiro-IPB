...
for($i=1; $i <= $qtd_parcelas; $i++){
	...
	$pdo->query("INSERT INTO $tabela SET empresa = '$id_empresa', tipo = 'Conta', descricao = '$nova_descricao', pessoa = '$pessoa', valor = '$novo_valor', data_venc = '$novo_vencimento', frequencia = '$frequencia', data_lanc = curDate(), usuario_lanc = '$id_usuario', arquivo = 'sem-foto.png', pago = 'Não'");
}
