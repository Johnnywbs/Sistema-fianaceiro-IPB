			...
			<div class="modal-body">			
				...
				<div class="row">
					<div class="col-md-12" align="center">		
						<div id="listar-detalhes-compra"></div>
					</div>
				</div>
...
<script type="text/javascript">
	function listarDetalhesCompra(idconta){
		var id_usuario = localStorage.id_usu;
	var id_empresa = localStorage.id_empresa;
			$.ajax({
				url: 'paginas/' + pag + "/listar-detalhes-compra.php",
				method: 'POST',
				data: {idconta, id_usuario, id_empresa},
				dataType: "html",

				success:function(result){
					$("#listar-detalhes-compra").html(result);
				}
			});
		}
</script>