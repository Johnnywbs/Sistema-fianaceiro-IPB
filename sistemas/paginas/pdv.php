    ...
    <div class="modal-content">
      ...
      <form method="POST" id="form-fechar-venda">
        ...
        <div class="row">
           <div class="col-md-4">
                  <div class="mb-3">
            <label for="exampleFormControlInput1" class="form-label">Garantia / Dias</label>
            <input type="number" name="garantia" id="garantia" class="form-control" value="" >
          </div>
            </div>
  ...
  if(porcent != "" && porcent != "undefined" && porcent != undefined){
   ...
   $("#listar_pix").html('');
    ...
    $.ajax({
      url: "../pix/pix.php",
      method: 'POST',
      data: {forma_pgto, totalantigo, id_empresa},
      dataType: "html",
