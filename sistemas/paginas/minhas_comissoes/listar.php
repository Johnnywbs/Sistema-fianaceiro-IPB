...
$query = $pdo->query("SELECT * FROM $tabela where empresa = '$id_empresa' and data_lanc >= '$data_inicial' and data_lanc <= '$data_final' and pago LIKE '%$status%' and vendedor = '$id_usuario' ORDER BY pago asc, data_lanc asc");
