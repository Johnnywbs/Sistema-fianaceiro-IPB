...
//CRIAR A PRÓXIMA CONTA A PAGAR CASO EXISTA RECORRENCIA / FREQUENCIA
	...
	if(@$dias_frequencia > 0){
		$pdo->query("INSERT INTO $tabela set empresa = '0', tipo = 'Empresa', descricao = '$descricao', pessoa = '$pessoa', valor = '$valor', data_lanc = curDate(), data_venc = '$nova_data_vencimento', frequencia = '$frequencia', arquivo = '$arquivo', pago = 'Não', garantia = '0', usuario_lanc = '$id_usuario'");
