...
$query = $pdo->prepare("UPDATE config SET nome_sistema = :nome_sistema, email_sistema = :email_sistema, telefone_sistema = :telefone_sistema, tipo_rel = '$tipo_rel', dias_bloqueio = '$dias_bloqueio', msg_bloqueio = :msg_bloqueio, teste = '$teste', dias_teste = '$dias_teste', token = '$token', instancia = '$instancia' where empresa = '0'");
