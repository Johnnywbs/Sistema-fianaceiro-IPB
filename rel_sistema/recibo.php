...
$descricao = $dados[0]['descricao_pgto'];
...
if($tipo == 'Nota de Serviço' or $tipo == 'Boleto'){
...
<div  class="th title" >Recibo</div>



<div style="padding:10px" align='center'><?php echo $nome_cliente ?>Recebi de <b><?php echo $nome_sistema ?></b>, Pessoa Jurídica, estabelecida no <b><?php echo $endereco_sistema ?></b>, inscrita no CNPJ sob o nº <b><?php echo @$cnpj_sistema ?></b>, a quantia de <b><?php echo $total_vendaF ?></b> na data <b><?php echo $data2 ?></b> correspondente à <b><?php echo $referente ?></b></div>
<br><br>
