...
$html = file_get_contents($url_sistema."rel_sistema/receber.php?dataInicial=$dataInicial&dataFinal=$dataFinal&pago=$pago&pessoa=$pessoa&busca=$busca&tipo=$tipo&id_empresa=$id_empresa");
