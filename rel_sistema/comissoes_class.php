...
$html = file_get_contents($url_sistema."rel_sistema/comissoes.php?dataInicial=$dataInicial&dataFinal=$dataFinal&pago=$pago&pessoa=$pessoa&busca=$busca&id_empresa=$id_empresa");
